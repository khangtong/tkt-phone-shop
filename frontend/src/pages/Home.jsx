...
const Home = () => {
	...
	const scrollCategoriesLeft = () => scrollContainer(categoriesContainerRef, 'left');
	const scrollCategoriesRight = () => scrollContainer(categoriesContainerRef, 'right');

	const scrollDiscountsLeft = () => scrollContainer(discountsContainerRef, 'left');
	const scrollDiscountsRight = () => scrollContainer(discountsContainerRef, 'right');
	...
	return (
		<div className='min-h-screen bg-gray-100 p-3 rounded-xl'>
			...
			<header className='bg-white shadow-md p-6 mt-8 rounded-lg mb-8'>
				<div className='uppercase pt-2 pl-2 text-decoration-line: underline'>Danh mục</div>
			...
			<section className='bg-white shadow-md p-4 rounded-lg mb-8'>
				<div className='uppercase pt-2 pl-2 text-decoration-line: underline'>Giảm giá</div>
				<div className='container mx-auto px-4 py-4 relative bg-slate-100 rounded-lg'>
					<button
			...
			<main className='container mx-auto px-4 py-8'>
				{Object.keys(groupedProducts).map((categoryName) => (
					<div key={categoryName} className='bg-white shadow-md p-4 rounded-lg mb-8'>
						<div className='uppercase pt-2 pl-2 text-decoration-line: underline'>
							{categoryName}
						</div>
						<div className='container mx-auto px-4 py-4 relative bg-slate-100 rounded-lg'>
							<nav
								ref={(ref) => (productsContainerRefs.current[categoryName] = ref)}
								className='flex overflow-x-auto scrollbar-hide gap-5'>
