		...
		<div className='flex h-screen bg-gray-100'>
			...
			<div className='w-4/5 p-6'>
				<div className='bg-white p-6 rounded-xl shadow-lg'>
					<h2 className='text-xl font-bold mb-4 text-center'>Quản lý biến thể</h2>
					...
					<CustomModalConfirm
						...
						textConfirm={'Bạn chắc chắc muốn xoá biến thể này?'}
						performAction={() => handleDeleteVariation(variationId)}
					/>
				</div>
			</div>
		</div>
